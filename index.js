...
client.once("ready", () => {
    console.log(" Zeioux DJ is ready!");
});
...
client.on("message", async (message) => {
    ...
    */
    if (!ZeiouxDJMap.get(message.guild.id)) {
        const botData = {
        ...
        ZeiouxDJMap.set(message.guild.id, botData);
    }
    const serverQueue = ZeiouxDJMap.get(message.guild.id);
